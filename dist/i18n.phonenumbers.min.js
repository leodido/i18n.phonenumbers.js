...
,"NA","NA"],,,[,,"NA","NA"],[,,"\\d{11}","\\d{11}",,,"12345678901"],1,,[,,"NA","NA"]],979:[,[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA"],[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA"],[,,"NA","NA"],[,,"NA","NA"],"001",979,"",,,,,,,1,[[,"(\\d)(\\d{4})(\\d{4})","$1 $2 $3",,"","",0]],,[,,"NA","NA"],,,[,,"NA","NA"],[,,"NA","NA"],1,,[,,"NA","NA"]]};var q=Array.prototype,ca=q.indexOf?function(a,b,c){return q.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(k(a))return k(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},da=q.filter?function(a,b,c){return q.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=[],e=0,g=k(a)?a.split(""):a,h=0;h<d;h++)if(h in g){var m=g[h];b.call(c,m,h,a)&&(f[e++]=m)}return f};function ea(a,b){a.sort(b||fa)}
...
return va};F.ctor=F;F.ctor.h=F.prototype.h;function G(a,b){null!=a&&this.a.apply(this,arguments)}G.prototype.b="";G.prototype.a=function(a,b,c){this.b+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.b+=arguments[d];return this};function H(a){a.b=""}G.prototype.toString=function(){return this.b};function xa(){}xa.prototype.a=function(a){new a.b;throw Error("Unimplemented");};xa.prototype.b=function(a,b){if(11==a.a||10==a.a)return b instanceof r?b:this.a(a.j.prototype.h(),b);if(14==a.a||!a.i)return b;var c=a.j;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&k(b)&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function ya(){}n(ya,xa);ya.prototype.a=function(a,b){var c=new a.b;c.g=this;c.b=b;c.a={};return c};function I(){}n(I,ya);I.prototype.b=function(a,b){return 8==a.a?!!b:xa.prototype.b.apply(this,arguments)};I.prototype.a=function(a,b){return I.ja.a.call(this,a,b)};
...
Ka=/(\$\d)/,La=/\$NP/,Ma=/\$FG/,Na=/\$CC/,Oa=/^\(?\$1\)?$/;function Pa(a){var b=a.search(Ea);0<=b?(a=a.substring(b),a=a.replace(Ga,""),b=a.search(Fa),0<=b&&(a=a.substring(0,b))):a="";return a}function Qa(a){return 2>a.length?!1:M(Ja,a)}function Ra(a){return M(Ha,a)?N(a,Aa):N(a,K)}function Sa(a){var b=Ra(a.toString());H(a);a.a(b)}function Ta(){return da(Object.keys(ba),function(a){return isNaN(a)})}
...
function lb(a,b,c,d,f){if(0==a.length)return 0;a=new G(a);var e;null!=b&&(e=x(b,11));null==e&&(e="NonMatch");var g=a.toString();if(0==g.length)e=20;else if(L.test(g))g=g.replace(L,""),H(a),a.a(Ra(g)),e=1;else{g=new RegExp(e);Sa(a);e=a.toString();if(0==e.search(g)){var g=e.match(g)[0].length,h=e.substring(g).match(Da);h&&null!=h[1]&&0<h[1].length&&"0"==N(h[1],K)?e=!1:(H(a),a.a(e.substring(g)),e=!0)}else e=!1;e=e?5:20}d&&w(f,6,e);if(20!=e){if(2>=a.b.length)throw"Phone number too short after IDD";c=
kb(a,c);if(0!=c)return w(f,1,c),c;throw"Invalid country calling code";}if(null!=b&&(e=y(b,10),g=""+e,h=a.toString(),0==h.lastIndexOf(g,0))){var m=new G(h.substring(g.length)),h=x(b,1),g=new RegExp(y(h,2));mb(m,b,null);b=m.toString();h=y(h,3);if(!M(g,a.toString())&&M(g,b)||3==hb(h,a.toString()))return c.a(b),d&&w(f,6,10),w(f,1,e),e}w(f,1,0);return 0}
...
e=f.toString();if(!(O(c)||null!=e&&0<e.length&&L.test(e)))throw"Invalid country calling code";e=new F;d&&w(e,5,b);a:{b=f.toString();g=b.search(Ia);if(0<=g&&Qa(b.substring(0,g)))for(var h=b.match(Ia),m=h.length,v=1;v<m;++v)if(null!=h[v]&&0<h[v].length){H(f);f.a(b.substring(0,g));b=h[v];break a}b=""}0<b.length&&w(e,3,b);b=V(a,c);g=new G;h=0;m=f.toString();try{h=lb(m,b,g,d,e)}catch(P){if("Invalid country calling code"==P&&L.test(m)){if(m=m.replace(L,""),h=lb(m,b,g,d,e),0==h)throw P;}else throw P;}0!=
h?(f=U(h),f!=c&&(b=T(a,h,f))):(Sa(f),g.a(f.toString()),null!=c?(h=y(b,10),w(e,1,h)):d&&A(e,6));if(2>g.b.length)throw"The string supplied is too short to be a phone number";null!=b&&(a=new G,c=new G(g.toString()),mb(c,b,a),ib(b,c.toString())||(g=c,d&&w(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw"The string supplied is too short to be a phone number";if(17<a)throw"The string supplied is too long to be a phone number";if(1<d.length&&"0"==d.charAt(0)){w(e,4,!0);for(a=1;a<d.length-1&&"0"==
...
function pb(a){this.ea=/\u2008/;this.s="";this.o=new G;this.w="";this.i=new G;this.l=new G;this.j=!0;this.$=this.u=this.ga=!1;this.aa=J.a();this.ia=this.ha=this.v=0;this.b=new G;this.ba=!1;this.m="";this.a=new G;this.f=[];this.fa=a;this.g=qb(this,this.fa)}var rb=new E;w(rb,11,"NA");
var sb=/\[([^\[\]])*\]/g,tb=/\d(?=[^,}][^,}])/g,ub=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,vb=/[- ]/;function qb(a,b){var c=O(b)?Ya(a.aa,b):0,c=V(a.aa,U(c));return null!=c?c:rb}
function wb(a){for(var b=a.f.length,c=0;c<b;++c){var d=a.f[c],f=y(d,1);if(a.w==f)return!1;var e;e=a;var g=d,h=y(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(sb,"\\d");h=h.replace(tb,"\\d");H(e.o);var m;m=e;var g=y(g,2),v="999999999999999".match(h)[0];v.length<m.a.b.length?m="":(m=v.replace(new RegExp(h,"g"),g),m=m.replace(/9/g,"\u2008"));0<m.length?(e.o.a(m),e=!0):e=!1}if(e)return a.w=f,a.ba=vb.test(x(d,4)),a.v=0,!0}return a.j=!1}
...
function Cb(a){var b=a.a.toString(),c=0,d;1!=x(a.g,10)?d=!1:(d=a.a.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.b.a("1").a(" "),a.u=!0):t(a.g,15)&&(d=new RegExp("^(?:"+x(a.g,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.u=!0,c=d[0].length,a.b.a(b.substring(0,c))));H(a.a);a.a.a(b.substring(c));return b.substring(0,c)}

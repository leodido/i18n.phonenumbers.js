...
,"NA","NA"],,,[,,"NA","NA"],[,,"\\d{11}","\\d{11}",,,"12345678901"],1,,[,,"NA","NA"]],979:[,[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA"],[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA"],[,,"NA","NA"],[,,"NA","NA"],"001",979,"",,,,,,,1,[[,"(\\d)(\\d{4})(\\d{4})","$1 $2 $3",,"","",0]],,[,,"NA","NA"],,,[,,"NA","NA"],[,,"NA","NA"],1,,[,,"NA","NA"]]};function q(a,b){null!=a&&this.a.apply(this,arguments)}q.prototype.b="";q.prototype.a=function(a,b,c){this.b+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.b+=arguments[d];return this};function r(a){a.b=""}q.prototype.toString=function(){return this.b};var t=Array.prototype,ca=t.indexOf?function(a,b,c){return t.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if(k(a))return k(b)&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1},da=t.filter?function(a,b,c){return t.filter.call(a,b,c)}:function(a,b,c){for(var d=a.length,f=[],e=0,g=k(a)?a.split(""):a,h=0;h<d;h++)if(h in g){var m=g[h];b.call(c,m,h,a)&&(f[e++]=m)}return f};function ea(a,b){a.sort(b||fa)}
function fa(a,b){return a>b?1:a<b?-1:0};function ga(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b};function ha(a,b){this.b=a;this.a={};for(var c=0;c<b.length;c++){var d=b[c];this.a[d.f]=d}}function ia(a){a=ga(a.a);ea(a,function(a,c){return a.f-c.f});return a};function ja(a,b){this.f=a;this.g=!!b.da;this.a=b.c;this.j=b.type;this.i=!1;switch(this.a){case ka:case la:case ma:case na:case oa:case pa:case qa:this.i=!0}this.b=b.defaultValue}var qa=1,pa=2,ka=3,la=4,ma=6,na=16,oa=18;function u(){this.b={};this.f=this.h().a;this.a=this.g=null}function ra(a,b){for(var c=ia(a.h()),d=0;d<c.length;d++){var f=c[d],e=f.f;if(v(b,e)){a.a&&delete a.a[f.f];var g=11==f.a||10==f.a;if(f.g)for(var f=x(b,e)||[],h=0;h<f.length;h++){var m=a,w=e,P=g?f[h].clone():f[h];m.b[w]||(m.b[w]=[]);m.b[w].push(P);m.a&&delete m.a[w]}else f=x(b,e),g?(g=x(a,e))?ra(g,f):y(a,e,f.clone()):y(a,e,f)}}}u.prototype.clone=function(){var a=new this.constructor;a!=this&&(a.b={},a.a&&(a.a={}),ra(a,this));return a};
function v(a,b){return null!=a.b[b]}function x(a,b){var c=a.b[b];if(null==c)return null;if(a.g){if(!(b in a.a)){var d=a.g,f=a.f[b];if(null!=c)if(f.g){for(var e=[],g=0;g<c.length;g++)e[g]=d.b(f,c[g]);c=e}else c=d.b(f,c);return a.a[b]=c}return a.a[b]}return c}function z(a,b,c){var d=x(a,b);return a.f[b].g?d[c||0]:d}
function A(a,b){var c;if(v(a,b))c=z(a,b,void 0);else a:{c=a.f[b];if(void 0===c.b){var d=c.j;if(d===Boolean)c.b=!1;else if(d===Number)c.b=0;else if(d===String)c.b=c.i?"0":"";else{c=new d;break a}}c=c.b}return c}function B(a,b){return a.f[b].g?v(a,b)?a.b[b].length:0:v(a,b)?1:0}function y(a,b,c){a.b[b]=c;a.a&&(a.a[b]=c)}function C(a,b){delete a.b[b];a.a&&delete a.a[b]}function D(a,b){var c=[],d;for(d in b)0!=d&&c.push(new ja(d,b[d]));return new ha(a,c)};
function E(){u.call(this)}var sa;n(E,u);function F(){u.call(this)}var ta;n(F,u);function G(){u.call(this)}var ua;n(G,u);
E.prototype.h=function(){sa||(sa=D(E,{0:{name:"NumberFormat",ca:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,c:9,type:String},2:{name:"format",required:!0,c:9,type:String},3:{name:"leading_digits_pattern",da:!0,c:9,type:String},4:{name:"national_prefix_formatting_rule",c:9,type:String},6:{name:"national_prefix_optional_when_formatting",c:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",c:9,type:String}}));return sa};E.ctor=E;E.ctor.h=E.prototype.h;
F.prototype.h=function(){ta||(ta=D(F,{0:{name:"PhoneNumberDesc",ca:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",c:9,type:String},3:{name:"possible_number_pattern",c:9,type:String},6:{name:"example_number",c:9,type:String},7:{name:"national_number_matcher_data",c:12,type:String},8:{name:"possible_number_matcher_data",c:12,type:String}}));return ta};F.ctor=F;F.ctor.h=F.prototype.h;
G.prototype.h=function(){ua||(ua=D(G,{0:{name:"PhoneMetadata",ca:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",c:11,type:F},2:{name:"fixed_line",c:11,type:F},3:{name:"mobile",c:11,type:F},4:{name:"toll_free",c:11,type:F},5:{name:"premium_rate",c:11,type:F},6:{name:"shared_cost",c:11,type:F},7:{name:"personal_number",c:11,type:F},8:{name:"voip",c:11,type:F},21:{name:"pager",c:11,type:F},25:{name:"uan",c:11,type:F},27:{name:"emergency",c:11,type:F},28:{name:"voicemail",c:11,type:F},24:{name:"no_international_dialling",
...
da:!0,c:11,type:E},20:{name:"intl_number_format",da:!0,c:11,type:E},22:{name:"main_country_for_code",c:8,defaultValue:!1,type:Boolean},23:{name:"leading_digits",c:9,type:String},26:{name:"leading_zero_possible",c:8,defaultValue:!1,type:Boolean}}));return ua};G.ctor=G;G.ctor.h=G.prototype.h;
function H(){u.call(this)}var va;n(H,u);var wa={na:1,ma:5,la:10,ka:20};
H.prototype.h=function(){va||(va=D(H,{0:{name:"PhoneNumber",ca:"i18n.phonenumbers.PhoneNumber"},1:{name:"country_code",required:!0,c:5,type:Number},2:{name:"national_number",required:!0,c:4,type:Number},3:{name:"extension",c:9,type:String},4:{name:"italian_leading_zero",c:8,type:Boolean},8:{name:"number_of_leading_zeros",c:5,defaultValue:1,type:Number},5:{name:"raw_input",c:9,type:String},6:{name:"country_code_source",c:14,defaultValue:1,type:wa},7:{name:"preferred_domestic_carrier_code",c:9,type:String}}));
return va};H.ctor=H;H.ctor.h=H.prototype.h;function xa(){}xa.prototype.a=function(a){new a.b;throw Error("Unimplemented");};xa.prototype.b=function(a,b){if(11==a.a||10==a.a)return b instanceof u?b:this.a(a.j.prototype.h(),b);if(14==a.a||!a.i)return b;var c=a.j;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&k(b)&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function ya(){}n(ya,xa);ya.prototype.a=function(a,b){var c=new a.b;c.g=this;c.b=b;c.a={};return c};function I(){}n(I,ya);I.prototype.b=function(a,b){return 8==a.a?!!b:xa.prototype.b.apply(this,arguments)};I.prototype.a=function(a,b){return I.ja.a.call(this,a,b)};
...
Ka=/(\$\d)/,La=/\$NP/,Ma=/\$FG/,Na=/\$CC/,Oa=/^\(?\$1\)?$/;function Pa(a){var b=a.search(Ea);0<=b?(a=a.substring(b),a=a.replace(Ga,""),b=a.search(Fa),0<=b&&(a=a.substring(0,b))):a="";return a}function Qa(a){return 2>a.length?!1:M(Ja,a)}function Ra(a){return M(Ha,a)?N(a,Aa):N(a,K)}function Sa(a){var b=Ra(a.toString());r(a);a.a(b)}function Ta(){return da(Object.keys(ba),function(a){return isNaN(a)})}
function N(a,b){for(var c=new q,d,f=a.length,e=0;e<f;++e)d=a.charAt(e),d=b[d.toUpperCase()],null!=d&&c.a(d);return c.toString()}function O(a){return null!=a&&isNaN(a)&&a.toUpperCase()in ba}function Q(a,b,c){if(0==z(b,2)&&v(b,5)){var d=A(b,5);if(0<d.length)return d}var d=A(b,1),f=R(b);if(0==c)return S(d,0,f,"");if(!(d in p))return f;a=T(a,d,U(d));b=Ua(b,a,c);f=Va(f,a,c);return S(d,c,f,b)}
function Wa(a,b,c){var d=A(b,1),f=R(b);if(!(d in p))return f;a=T(a,d,U(d));b=Ua(b,a,2);c=Va(f,a,2,c);return S(d,2,c,b)}function T(a,b,c){return"001"==c?V(a,""+b):V(a,c)}
function Xa(a,b,c){if(!O(c))return Q(a,b,1);var d=A(b,1),f=R(b);if(!(d in p))return f;if(1==d){if(null!=c&&0<=ca(p[1],c.toUpperCase()))return d+" "+Q(a,b,2)}else if(d==Ya(a,c))return Q(a,b,2);var e=V(a,c),g=A(e,11);c="";M(Ba,g)?c=g:v(e,17)&&(c=A(e,17));a=T(a,d,U(d));f=Va(f,a,1);b=Ua(b,a,1);return 0<c.length?c+" "+d+" "+f+b:S(d,1,f,b)}function R(a){var b=""+z(a,2);return v(a,4)&&z(a,4)?Array(A(a,8)+1).join("0")+b:b}
function S(a,b,c,d){switch(b){case 0:return"+"+a+c+d;case 1:return"+"+a+" "+c+d;case 3:return"tel:+"+a+"-"+c+d;default:return c+d}}function Va(a,b,c,d){b=0==(x(b,20)||[]).length||2==c?x(b,19)||[]:x(b,20)||[];b=Za(b,a);return null==b?a:$a(a,b,c,d)}function Za(a,b){for(var c,d=a.length,f=0;f<d;++f){c=a[f];var e=B(c,3);if(0==e||0==b.search(z(c,3,e-1)))if(e=new RegExp(z(c,1)),M(e,b))return c}return null}
function $a(a,b,c,d){var f=A(b,2),e=new RegExp(z(b,1)),g=A(b,5),h="";2==c&&null!=d&&0<d.length&&0<g.length?(b=g.replace(Na,d),f=f.replace(Ka,b),h=a.replace(e,f)):(b=A(b,4),h=2==c&&null!=b&&0<b.length?a.replace(e,f.replace(Ka,b)):a.replace(e,f));3==c&&(h=h.replace(/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/,""),h=h.replace(/[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/g,
"-"));return h}function Ua(a,b,c){return v(a,3)&&0!=z(a,3).length?3==c?";ext="+z(a,3):v(b,13)?z(b,13)+A(a,3):" ext. "+A(a,3):""}function ab(a,b){switch(b){case 4:return z(a,5);case 3:return z(a,4);case 1:return z(a,3);case 0:case 2:return z(a,2);case 5:return z(a,6);case 6:return z(a,8);case 7:return z(a,7);case 8:return z(a,21);case 9:return z(a,25);case 10:return z(a,28);default:return z(a,1)}}function bb(a,b){var c=cb(a,b),c=T(a,A(b,1),c);if(null==c)return-1;var d=R(b);return db(d,c)}
function db(a,b){return W(a,z(b,1))?W(a,z(b,5))?4:W(a,z(b,4))?3:W(a,z(b,6))?5:W(a,z(b,8))?6:W(a,z(b,7))?7:W(a,z(b,21))?8:W(a,z(b,25))?9:W(a,z(b,28))?10:W(a,z(b,2))?z(b,18)||W(a,z(b,3))?2:0:!z(b,18)&&W(a,z(b,3))?1:-1:-1}function V(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.a[b];if(null==c){c=ba[b];if(null==c)return null;c=(new I).a(G.h(),c);a.a[b]=c}return c}function W(a,b){return M(A(b,3),a)&&M(A(b,2),a)}function eb(a,b){var c=cb(a,b);return fb(a,b,c)}
function fb(a,b,c){var d=A(b,1),f=T(a,d,c);if(null==f||"001"!=c&&d!=Ya(a,c))return!1;a=R(b);return-1!=db(a,f)}function cb(a,b){if(null==b)return null;var c=A(b,1),c=p[c];if(null==c)c=null;else if(1==c.length)c=c[0];else a:{for(var d=R(b),f,e=c.length,g=0;g<e;g++){f=c[g];var h=V(a,f);if(v(h,23)){if(0==d.search(z(h,23))){c=f;break a}}else if(-1!=db(d,h)){c=f;break a}}c=null}return c}function U(a){a=p[a];return null==a?"ZZ":a[0]}
function Ya(a,b){var c=V(a,b);if(null==c)throw"Invalid region code: "+b;return A(c,10)}function gb(a,b){var c=V(a,b);if(null==c)return null;c=A(c,12);return 0==c.length?null:c=c.replace("~","")}function hb(a,b){return M(a,b)?0:0==b.search(a)?3:2}function ib(a,b){var c;c=z(a,1);c=A(c,3);return 2==hb(c,b)}function jb(a){var b=X,c=R(a);a=A(a,1);if(!(a in p))return 1;b=T(b,a,U(a));b=z(b,1);b=A(b,3);return hb(b,c)}
...
function lb(a,b,c,d,f){if(0==a.length)return 0;a=new q(a);var e;null!=b&&(e=z(b,11));null==e&&(e="NonMatch");var g=a.toString();if(0==g.length)e=20;else if(L.test(g))g=g.replace(L,""),r(a),a.a(Ra(g)),e=1;else{g=new RegExp(e);Sa(a);e=a.toString();if(0==e.search(g)){var g=e.match(g)[0].length,h=e.substring(g).match(Da);h&&null!=h[1]&&0<h[1].length&&"0"==N(h[1],K)?e=!1:(r(a),a.a(e.substring(g)),e=!0)}else e=!1;e=e?5:20}d&&y(f,6,e);if(20!=e){if(2>=a.b.length)throw"Phone number too short after IDD";c=
kb(a,c);if(0!=c)return y(f,1,c),c;throw"Invalid country calling code";}if(null!=b&&(e=A(b,10),g=""+e,h=a.toString(),0==h.lastIndexOf(g,0))){var m=new q(h.substring(g.length)),h=z(b,1),g=new RegExp(A(h,2));mb(m,b,null);b=m.toString();h=A(h,3);if(!M(g,a.toString())&&M(g,b)||3==hb(h,a.toString()))return c.a(b),d&&y(f,6,10),y(f,1,e),e}y(f,1,0);return 0}
...
function nb(a,b,c,d){if(null==b)throw"The string supplied did not seem to be a phone number";if(250<b.length)throw"The string supplied is too long to be a phone number";var f=new q,e=b.indexOf(";phone-context=");if(0<e){var g=e+15;if("+"==b.charAt(g)){var h=b.indexOf(";",g);0<h?f.a(b.substring(g,h)):f.a(b.substring(g))}g=b.indexOf("tel:");f.a(b.substring(0<=g?g+4:0,e))}else f.a(Pa(b));e=f.toString();g=e.indexOf(";isub=");0<g&&(r(f),f.a(e.substring(0,g)));if(!Qa(f.toString()))throw"The string supplied did not seem to be a phone number";
e=f.toString();if(!(O(c)||null!=e&&0<e.length&&L.test(e)))throw"Invalid country calling code";e=new H;d&&y(e,5,b);a:{b=f.toString();g=b.search(Ia);if(0<=g&&Qa(b.substring(0,g)))for(var h=b.match(Ia),m=h.length,w=1;w<m;++w)if(null!=h[w]&&0<h[w].length){r(f);f.a(b.substring(0,g));b=h[w];break a}b=""}0<b.length&&y(e,3,b);b=V(a,c);g=new q;h=0;m=f.toString();try{h=lb(m,b,g,d,e)}catch(P){if("Invalid country calling code"==P&&L.test(m)){if(m=m.replace(L,""),h=lb(m,b,g,d,e),0==h)throw P;}else throw P;}0!=
h?(f=U(h),f!=c&&(b=T(a,h,f))):(Sa(f),g.a(f.toString()),null!=c?(h=A(b,10),y(e,1,h)):d&&C(e,6));if(2>g.b.length)throw"The string supplied is too short to be a phone number";null!=b&&(a=new q,c=new q(g.toString()),mb(c,b,a),ib(b,c.toString())||(g=c,d&&y(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw"The string supplied is too short to be a phone number";if(17<a)throw"The string supplied is too long to be a phone number";if(1<d.length&&"0"==d.charAt(0)){y(e,4,!0);for(a=1;a<d.length-1&&"0"==
d.charAt(a);)a++;1!=a&&y(e,8,a)}y(e,2,parseInt(d,10));return e}function ob(a,b){var c=V(a,cb(a,b));if(null==c)return!0;var d=R(b);return!W(d,z(c,24))}function M(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};
function pb(a){this.ea=/\u2008/;this.s="";this.o=new q;this.w="";this.i=new q;this.l=new q;this.j=!0;this.$=this.u=this.ga=!1;this.aa=J.a();this.ia=this.ha=this.v=0;this.b=new q;this.ba=!1;this.m="";this.a=new q;this.f=[];this.fa=a;this.g=qb(this,this.fa)}var rb=new G;y(rb,11,"NA");
var sb=/\[([^\[\]])*\]/g,tb=/\d(?=[^,}][^,}])/g,ub=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,vb=/[- ]/;function qb(a,b){var c=O(b)?Ya(a.aa,b):0,c=V(a.aa,U(c));return null!=c?c:rb}
function wb(a){for(var b=a.f.length,c=0;c<b;++c){var d=a.f[c],f=A(d,1);if(a.w==f)return!1;var e;e=a;var g=d,h=A(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(sb,"\\d");h=h.replace(tb,"\\d");r(e.o);var m;m=e;var g=A(g,2),w="999999999999999".match(h)[0];w.length<m.a.b.length?m="":(m=w.replace(new RegExp(h,"g"),g),m=m.replace(/9/g,"\u2008"));0<m.length?(e.o.a(m),e=!0):e=!1}if(e)return a.w=f,a.ba=vb.test(z(d,4)),a.v=0,!0}return a.j=!1}
function xb(a,b){for(var c=[],d=b.length-3,f=a.f.length,e=0;e<f;++e){var g=a.f[e];if(0==B(g,3))c.push(a.f[e]);else{var h=Math.min(d,B(g,3)-1),g=z(g,3,h);0==b.search(g)&&c.push(a.f[e])}}a.f=c}
function yb(a,b,c){a.i.a(b);c&&(a.ha=a.i.b.length);var d=b;Da.test(d)||1==a.i.b.length&&Ca.test(d)?("+"==b?(d=b,a.l.a(b)):(d=K[b],a.l.a(d),a.a.a(d)),c&&(a.ia=a.l.b.length),b=d):(a.j=!1,a.ga=!0);if(!a.j){if(!a.ga)if(zb(a)){if(Ab(a))return Bb(a)}else if(0<a.m.length&&(c=a.a.toString(),r(a.a),a.a.a(a.m),a.a.a(c),c=a.b.toString(),b=c.lastIndexOf(a.m),r(a.b),a.b.a(c.substring(0,b))),a.m!=Cb(a))return a.b.a(" "),Bb(a);return a.i.toString()}switch(a.l.b.length){case 0:case 1:case 2:return a.i.toString();
case 3:if(zb(a))a.$=!0;else return a.m=Cb(a),Db(a);default:if(a.$)return Ab(a)&&(a.$=!1),a.b.toString()+a.a.toString();if(0<a.f.length){c=Eb(a,b);b=Fb(a);if(0<b.length)return b;xb(a,a.a.toString());return wb(a)?Gb(a):a.j?Hb(a,c):a.i.toString()}return Db(a)}}function Bb(a){a.j=!0;a.$=!1;a.f=[];a.v=0;r(a.o);a.w="";return Db(a)}
function Fb(a){for(var b=a.a.toString(),c=a.f.length,d=0;d<c;++d){var f=a.f[d],e=A(f,1);if((new RegExp("^(?:"+e+")$")).test(b))return a.ba=vb.test(z(f,4)),b=b.replace(new RegExp(e,"g"),z(f,2)),Hb(a,b)}return""}function Hb(a,b){var c=a.b.b.length;return a.ba&&0<c&&" "!=a.b.toString().charAt(c-1)?a.b+" "+b:a.b+b}
function Db(a){var b=a.a.toString();if(3<=b.length){for(var c=a.u&&0<B(a.g,20)?x(a.g,20)||[]:x(a.g,19)||[],d=c.length,f=0;f<d;++f){var e=c[f],g;(g=!v(a.g,12)||a.u||z(e,6))||(g=A(e,4),g=0==g.length||Oa.test(g));g&&(g=A(e,2),ub.test(g)&&a.f.push(e))}xb(a,b);b=Fb(a);return 0<b.length?b:wb(a)?Gb(a):a.i.toString()}return Hb(a,b)}function Gb(a){var b=a.a.toString(),c=b.length;if(0<c){for(var d="",f=0;f<c;f++)d=Eb(a,b.charAt(f));return a.j?Hb(a,d):a.i.toString()}return a.b.toString()}
function Cb(a){var b=a.a.toString(),c=0,d;1!=z(a.g,10)?d=!1:(d=a.a.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.b.a("1").a(" "),a.u=!0):v(a.g,15)&&(d=new RegExp("^(?:"+z(a.g,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.u=!0,c=d[0].length,a.b.a(b.substring(0,c))));r(a.a);a.a.a(b.substring(c));return b.substring(0,c)}
function zb(a){var b=a.l.toString(),c=new RegExp("^(?:\\+|"+z(a.g,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.u=!0,c=c[0].length,r(a.a),a.a.a(b.substring(c)),r(a.b),a.b.a(b.substring(0,c)),"+"!=b.charAt(0)&&a.b.a(" "),!0):!1}function Ab(a){if(0==a.a.b.length)return!1;var b=new q,c=kb(a.a,b);if(0==c)return!1;r(a.a);a.a.a(b.toString());b=U(c);"001"==b?a.g=V(a.aa,""+c):b!=a.fa&&(a.g=qb(a,b));a.b.a(""+c).a(" ");a.m="";return!0}
function Eb(a,b){var c=a.o.toString();if(0<=c.substring(a.v).search(a.ea)){var d=c.search(a.ea),c=c.replace(a.ea,b);r(a.o);a.o.a(c);a.v=d;return c.substring(0,a.v+1)}1==a.f.length&&(a.j=!1);a.w="";return a.i.toString()};
...
l("leodido.i18n.PhoneNumbers.formatOriginal",function(a,b){b=b||"us";var c;c=Y(a,b);var d=b,f=X,e;if(!(e=!v(c,5))){if(e=v(c,4))e=A(c,1),e=T(f,e,U(e)),e=!(null!=e&&A(e,26));if(e=!e)if(e=A(c,1),e=T(f,e,U(e)),null==e)e=!1;else{var g=R(c);e=null!=Za(x(e,19)||[],g)}}if(e)if(v(c,6)){switch(z(c,6)){case 1:f=Q(f,c,1);break;case 5:f=Xa(f,c,d);break;case 10:f=Q(f,c,1).substring(1);break;default:e=U(A(c,1));g=gb(f,e);d=Q(f,c,2);if(null==g||0==g.length){f=d;break}var h;b:{var m=A(c,5),m=N(m,K);if(0==m.lastIndexOf(g,
0))try{h=eb(f,nb(f,m.substring(g.length),e,!1));break b}catch(w){}h=!1}if(h){f=d;break}h=V(f,e);e=R(c);h=Za(x(h,19)||[],e);if(null==h){f=d;break}e=A(h,4);g=e.indexOf("$1");if(0>=g){f=d;break}e=e.substring(0,g);e=N(e,K);if(0==e.length){f=d;break}h=h.clone();C(h,4);e=[h];h=A(c,1);d=R(c);h in p?(f=T(f,h,U(h)),g="",g=Za(e,d),null==g?g=d:(e=g.clone(),g=A(g,4),0<g.length&&(m=A(f,12),0<m.length?(g=g.replace(La,m).replace(Ma,"$1"),y(e,4,g)):C(e,4)),g=$a(d,e,2)),f=Ua(c,f,2),f=S(h,2,g,f)):f=d}c=A(c,5);null!=
f&&0<c.length&&(h=N(f,za),d=N(c,za),h!=d&&(f=c));c=f}else c=Q(f,c,2);else c=A(c,5);return c});l("leodido.i18n.PhoneNumbers.formatOutOfCountryCalling",function(a,b,c){b=Y(b,c||"us");return Xa(X,b,a)});
l("leodido.i18n.PhoneNumbers.formatMobileDialing",function(a,b,c){a:{var d=Y(b,c||"us");c=X;var f=A(d,1);if(f in p){var e="",d=d.clone();C(d,3);var g=U(f),h=bb(c,d),m=-1!=h;if(a==g)e=0==h||1==h||2==h,"CO"==g&&0==h?e=Wa(c,d,"3"):"BR"==g&&e?e=v(d,7)?Wa(c,d,v(d,7)?A(d,7):""):"":m&&"HU"==g?e=gb(c,g)+" "+Q(c,d,2):1==f?(f=V(c,a),e=ob(c,d)&&!ib(f,R(d))?Q(c,d,1):Q(c,d,2)):e=("001"==g||("MX"==g||"CL"==g)&&e)&&ob(c,d)?Q(c,d,1):Q(c,d,2);else if(m&&ob(c,d)){c=Q(c,d,1);break a}c=e}else c=v(d,5)?A(d,5):""}if(""===
c)throw Error('Current phone number (i.e., "'+b+'") can not be dialed from a mobile phone within the "'+a.toUpperCase()+'" region');return c});l("leodido.i18n.PhoneNumbers.formatNationalWithCarrierCode",function(a,b,c){b=Y(b,c||"us");return Wa(X,b,a)});l("leodido.i18n.PhoneNumbers.formatNationalWithPreferredCarrierCode",function(a,b,c){b=Y(b,c||"us");return Wa(X,b,v(b,7)?A(b,7):a)});
l("leodido.i18n.PhoneNumbers.getExampleNumber",function(a,b,c){var d;a:{var f=X;if(O(a)){b=ab(V(f,a),b);try{if(v(b,6)){var e=A(b,6);d=nb(f,e,a,!1);break a}}catch(g){}}d=null}return d?Q(X,d,"undefined"==typeof c?0:c):null});l("leodido.i18n.PhoneNumbers.isValidNumber",function(a,b){var c=Y(a,b||"us");return eb(X,c)});l("leodido.i18n.PhoneNumbers.isValidNumberForRegion",function(a,b){var c=Y(a,b);return fb(X,c,b)});

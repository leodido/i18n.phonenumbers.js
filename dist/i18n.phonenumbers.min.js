...
function ea(a,b){return a>b?1:a<b?-1:0};function fa(a,b){this.f=a;this.g=!!b.da;this.a=b.c;this.j=b.type;this.i=!1;switch(this.a){case ga:case ha:case ia:case ja:case ka:case la:case ma:this.i=!0}this.b=b.defaultValue}var ma=1,la=2,ga=3,ha=4,ia=6,ja=16,ka=18;function na(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b};function oa(a,b){this.b=a;this.a={};for(var c=0;c<b.length;c++){var d=b[c];this.a[d.f]=d}}function pa(a){a=na(a.a);da(a,function(a,c){return a.f-c.f});return a};function q(){this.b={};this.f=this.h().a;this.a=this.g=null}function qa(a,b){for(var c=pa(a.h()),d=0;d<c.length;d++){var f=c[d],e=f.f;if(r(b,e)){a.a&&delete a.a[f.f];var g=11==f.a||10==f.a;if(f.g)for(var f=t(b,e)||[],h=0;h<f.length;h++){var m=a,v=e,P=g?f[h].clone():f[h];m.b[v]||(m.b[v]=[]);m.b[v].push(P);m.a&&delete m.a[v]}else f=t(b,e),g?(g=t(a,e))?qa(g,f):u(a,e,f.clone()):u(a,e,f)}}}q.prototype.clone=function(){var a=new this.constructor;a!=this&&(a.b={},a.a&&(a.a={}),qa(a,this));return a};
...
function x(a,b){var c;if(r(a,b))c=w(a,b,void 0);else a:{c=a.f[b];if(void 0===c.b){var d=c.j;if(d===Boolean)c.b=!1;else if(d===Number)c.b=0;else if(d===String)c.b=c.i?"0":"";else{c=new d;break a}}c=c.b}return c}function y(a,b){return a.f[b].g?r(a,b)?a.b[b].length:0:r(a,b)?1:0}function u(a,b,c){a.b[b]=c;a.a&&(a.a[b]=c)}function z(a,b){delete a.b[b];a.a&&delete a.a[b]}function A(a,b){var c=[],d;for(d in b)0!=d&&c.push(new fa(d,b[d]));return new oa(a,c)};function ra(){}ra.prototype.a=function(a){new a.b;throw Error("Unimplemented");};ra.prototype.b=function(a,b){if(11==a.a||10==a.a)return b instanceof q?b:this.a(a.j.prototype.h(),b);if(14==a.a||!a.i)return b;var c=a.j;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&k(b)&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function sa(){}n(sa,ra);sa.prototype.a=function(a,b){var c=new a.b;c.g=this;c.b=b;c.a={};return c};function B(){}n(B,sa);B.prototype.b=function(a,b){return 8==a.a?!!b:ra.prototype.b.apply(this,arguments)};B.prototype.a=function(a,b){return B.ja.a.call(this,a,b)};function C(a,b){null!=a&&this.a.apply(this,arguments)}C.prototype.b="";C.prototype.a=function(a,b,c){this.b+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.b+=arguments[d];return this};function D(a){a.b=""}C.prototype.toString=function(){return this.b};
function E(){q.call(this)}var ta;n(E,q);function F(){q.call(this)}var ua;n(F,q);function G(){q.call(this)}var va;n(G,q);
E.prototype.h=function(){ta||(ta=A(E,{0:{name:"NumberFormat",ca:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,c:9,type:String},2:{name:"format",required:!0,c:9,type:String},3:{name:"leading_digits_pattern",da:!0,c:9,type:String},4:{name:"national_prefix_formatting_rule",c:9,type:String},6:{name:"national_prefix_optional_when_formatting",c:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",c:9,type:String}}));return ta};E.ctor=E;E.ctor.h=E.prototype.h;
F.prototype.h=function(){ua||(ua=A(F,{0:{name:"PhoneNumberDesc",ca:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",c:9,type:String},3:{name:"possible_number_pattern",c:9,type:String},6:{name:"example_number",c:9,type:String},7:{name:"national_number_matcher_data",c:12,type:String},8:{name:"possible_number_matcher_data",c:12,type:String}}));return ua};F.ctor=F;F.ctor.h=F.prototype.h;
G.prototype.h=function(){va||(va=A(G,{0:{name:"PhoneMetadata",ca:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",c:11,type:F},2:{name:"fixed_line",c:11,type:F},3:{name:"mobile",c:11,type:F},4:{name:"toll_free",c:11,type:F},5:{name:"premium_rate",c:11,type:F},6:{name:"shared_cost",c:11,type:F},7:{name:"personal_number",c:11,type:F},8:{name:"voip",c:11,type:F},21:{name:"pager",c:11,type:F},25:{name:"uan",c:11,type:F},27:{name:"emergency",c:11,type:F},28:{name:"voicemail",c:11,type:F},24:{name:"no_international_dialling",
...
da:!0,c:11,type:E},20:{name:"intl_number_format",da:!0,c:11,type:E},22:{name:"main_country_for_code",c:8,defaultValue:!1,type:Boolean},23:{name:"leading_digits",c:9,type:String},26:{name:"leading_zero_possible",c:8,defaultValue:!1,type:Boolean}}));return va};G.ctor=G;G.ctor.h=G.prototype.h;
...
Ka=/(\$\d)/,La=/\$NP/,Ma=/\$FG/,Na=/\$CC/,Oa=/^\(?\$1\)?$/;function Pa(a){var b=a.search(Ea);0<=b?(a=a.substring(b),a=a.replace(Ga,""),b=a.search(Fa),0<=b&&(a=a.substring(0,b))):a="";return a}function Qa(a){return 2>a.length?!1:M(Ja,a)}function Ra(a){return M(Ha,a)?N(a,Aa):N(a,K)}function Sa(a){var b=Ra(a.toString());D(a);a.a(b)}function Ta(){return ca(Object.keys(ya),function(a){return isNaN(a)})}
...
function lb(a,b,c,d,f){if(0==a.length)return 0;a=new C(a);var e;null!=b&&(e=w(b,11));null==e&&(e="NonMatch");var g=a.toString();if(0==g.length)e=20;else if(L.test(g))g=g.replace(L,""),D(a),a.a(Ra(g)),e=1;else{g=new RegExp(e);Sa(a);e=a.toString();if(0==e.search(g)){var g=e.match(g)[0].length,h=e.substring(g).match(Da);h&&null!=h[1]&&0<h[1].length&&"0"==N(h[1],K)?e=!1:(D(a),a.a(e.substring(g)),e=!0)}else e=!1;e=e?5:20}d&&u(f,6,e);if(20!=e){if(2>=a.b.length)throw"Phone number too short after IDD";c=
kb(a,c);if(0!=c)return u(f,1,c),c;throw"Invalid country calling code";}if(null!=b&&(e=x(b,10),g=""+e,h=a.toString(),0==h.lastIndexOf(g,0))){var m=new C(h.substring(g.length)),h=w(b,1),g=new RegExp(x(h,2));mb(m,b,null);b=m.toString();h=x(h,3);if(!M(g,a.toString())&&M(g,b)||3==hb(h,a.toString()))return c.a(b),d&&u(f,6,10),u(f,1,e),e}u(f,1,0);return 0}
...
function nb(a,b,c,d){if(null==b)throw"The string supplied did not seem to be a phone number";if(250<b.length)throw"The string supplied is too long to be a phone number";var f=new C,e=b.indexOf(";phone-context=");if(0<e){var g=e+15;if("+"==b.charAt(g)){var h=b.indexOf(";",g);0<h?f.a(b.substring(g,h)):f.a(b.substring(g))}g=b.indexOf("tel:");f.a(b.substring(0<=g?g+4:0,e))}else f.a(Pa(b));e=f.toString();g=e.indexOf(";isub=");0<g&&(D(f),f.a(e.substring(0,g)));if(!Qa(f.toString()))throw"The string supplied did not seem to be a phone number";
e=f.toString();if(!(O(c)||null!=e&&0<e.length&&L.test(e)))throw"Invalid country calling code";e=new H;d&&u(e,5,b);a:{b=f.toString();g=b.search(Ia);if(0<=g&&Qa(b.substring(0,g)))for(var h=b.match(Ia),m=h.length,v=1;v<m;++v)if(null!=h[v]&&0<h[v].length){D(f);f.a(b.substring(0,g));b=h[v];break a}b=""}0<b.length&&u(e,3,b);b=V(a,c);g=new C;h=0;m=f.toString();try{h=lb(m,b,g,d,e)}catch(P){if("Invalid country calling code"==P&&L.test(m)){if(m=m.replace(L,""),h=lb(m,b,g,d,e),0==h)throw P;}else throw P;}0!=
h?(f=U(h),f!=c&&(b=T(a,h,f))):(Sa(f),g.a(f.toString()),null!=c?(h=x(b,10),u(e,1,h)):d&&z(e,6));if(2>g.b.length)throw"The string supplied is too short to be a phone number";null!=b&&(a=new C,c=new C(g.toString()),mb(c,b,a),ib(b,c.toString())||(g=c,d&&u(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw"The string supplied is too short to be a phone number";if(17<a)throw"The string supplied is too long to be a phone number";if(1<d.length&&"0"==d.charAt(0)){u(e,4,!0);for(a=1;a<d.length-1&&"0"==
...
function pb(a){this.ea=/\u2008/;this.s="";this.o=new C;this.w="";this.i=new C;this.l=new C;this.j=!0;this.$=this.u=this.ga=!1;this.aa=J.a();this.ia=this.ha=this.v=0;this.b=new C;this.ba=!1;this.m="";this.a=new C;this.f=[];this.fa=a;this.g=qb(this,this.fa)}var rb=new G;u(rb,11,"NA");
var sb=/\[([^\[\]])*\]/g,tb=/\d(?=[^,}][^,}])/g,ub=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,vb=/[- ]/;function qb(a,b){var c=O(b)?Ya(a.aa,b):0,c=V(a.aa,U(c));return null!=c?c:rb}
function wb(a){for(var b=a.f.length,c=0;c<b;++c){var d=a.f[c],f=x(d,1);if(a.w==f)return!1;var e;e=a;var g=d,h=x(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(sb,"\\d");h=h.replace(tb,"\\d");D(e.o);var m;m=e;var g=x(g,2),v="999999999999999".match(h)[0];v.length<m.a.b.length?m="":(m=v.replace(new RegExp(h,"g"),g),m=m.replace(/9/g,"\u2008"));0<m.length?(e.o.a(m),e=!0):e=!1}if(e)return a.w=f,a.ba=vb.test(w(d,4)),a.v=0,!0}return a.j=!1}
...
function yb(a,b,c){a.i.a(b);c&&(a.ha=a.i.b.length);var d=b;Da.test(d)||1==a.i.b.length&&Ca.test(d)?("+"==b?(d=b,a.l.a(b)):(d=K[b],a.l.a(d),a.a.a(d)),c&&(a.ia=a.l.b.length),b=d):(a.j=!1,a.ga=!0);if(!a.j){if(!a.ga)if(zb(a)){if(Ab(a))return Bb(a)}else if(0<a.m.length&&(c=a.a.toString(),D(a.a),a.a.a(a.m),a.a.a(c),c=a.b.toString(),b=c.lastIndexOf(a.m),D(a.b),a.b.a(c.substring(0,b))),a.m!=Cb(a))return a.b.a(" "),Bb(a);return a.i.toString()}switch(a.l.b.length){case 0:case 1:case 2:return a.i.toString();
case 3:if(zb(a))a.$=!0;else return a.m=Cb(a),Db(a);default:if(a.$)return Ab(a)&&(a.$=!1),a.b.toString()+a.a.toString();if(0<a.f.length){c=Eb(a,b);b=Fb(a);if(0<b.length)return b;xb(a,a.a.toString());return wb(a)?Gb(a):a.j?Hb(a,c):a.i.toString()}return Db(a)}}function Bb(a){a.j=!0;a.$=!1;a.f=[];a.v=0;D(a.o);a.w="";return Db(a)}
...
function Cb(a){var b=a.a.toString(),c=0,d;1!=w(a.g,10)?d=!1:(d=a.a.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.b.a("1").a(" "),a.u=!0):r(a.g,15)&&(d=new RegExp("^(?:"+w(a.g,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.u=!0,c=d[0].length,a.b.a(b.substring(0,c))));D(a.a);a.a.a(b.substring(c));return b.substring(0,c)}
function zb(a){var b=a.l.toString(),c=new RegExp("^(?:\\+|"+w(a.g,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.u=!0,c=c[0].length,D(a.a),a.a.a(b.substring(c)),D(a.b),a.b.a(b.substring(0,c)),"+"!=b.charAt(0)&&a.b.a(" "),!0):!1}function Ab(a){if(0==a.a.b.length)return!1;var b=new C,c=kb(a.a,b);if(0==c)return!1;D(a.a);a.a.a(b.toString());b=U(c);"001"==b?a.g=V(a.aa,""+c):b!=a.fa&&(a.g=qb(a,b));a.b.a(""+c).a(" ");a.m="";return!0}
function Eb(a,b){var c=a.o.toString();if(0<=c.substring(a.v).search(a.ea)){var d=c.search(a.ea),c=c.replace(a.ea,b);D(a.o);a.o.a(c);a.v=d;return c.substring(0,a.v+1)}1==a.f.length&&(a.j=!1);a.w="";return a.i.toString()};

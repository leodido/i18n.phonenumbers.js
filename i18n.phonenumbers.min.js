...
ua:!0,a:11,type:x},20:{name:"intl_number_format",ua:!0,a:11,type:x},22:{name:"main_country_for_code",a:8,defaultValue:!1,type:Boolean},23:{name:"leading_digits",a:9,type:String},26:{name:"leading_zero_possible",a:8,defaultValue:!1,type:Boolean}}));return va};z.ctor=z;z.ctor.f=z.prototype.f;
function A(){n.call(this)}var wa;l(A,n);A.prototype.wa=function(){return q(this,1)};A.prototype.e=function(){return v(this,1)};A.prototype.ba=function(a){r(this,1,a)};A.prototype.getExtension=function(){return q(this,3)};var xa={Ha:1,Ga:5,Fa:10,Ea:20};
A.prototype.f=function(){wa||(wa=sa(A,{0:{name:"PhoneNumber",ja:"i18n.phonenumbers.PhoneNumber"},1:{name:"country_code",required:!0,a:5,type:Number},2:{name:"national_number",required:!0,a:4,type:Number},3:{name:"extension",a:9,type:String},4:{name:"italian_leading_zero",a:8,type:Boolean},8:{name:"number_of_leading_zeros",a:5,defaultValue:1,type:Number},5:{name:"raw_input",a:9,type:String},6:{name:"country_code_source",a:14,defaultValue:1,type:xa},7:{name:"preferred_domestic_carrier_code",a:9,type:String}}));
return wa};A.ctor=A;A.ctor.f=A.prototype.f;function B(a,b){null!=a&&this.append.apply(this,arguments)}B.prototype.d="";B.prototype.set=function(a){this.d=""+a};B.prototype.append=function(a,b,c){this.d+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.d+=arguments[d];return this};B.prototype.clear=function(){this.d=""};B.prototype.toString=function(){return this.d};function ya(){}ya.prototype.$=function(a){new a.za;throw Error("Unimplemented");};ya.prototype.ca=function(a,b){if(11==a.q||10==a.q)return b instanceof n?b:this.$(a.qa.prototype.f(),b);if(14==a.q||!a.ha)return b;var c=a.qa;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&"string"==typeof b&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function za(){}l(za,ya);za.prototype.$=function(a,b){var c=new a.za;c.oa=this;c.l=b;c.g={};return c};function C(){}l(C,za);C.prototype.Da=!1;C.prototype.ca=function(a,b){return 8==a.q?!!b:ya.prototype.ca.apply(this,arguments)};C.prototype.$=function(a,b){var c=b;if(this.Da){var c=[],d;for(d in b)c[parseInt(d,10)+1]=b[d]}return C.Ca.$.call(this,a,c)};
...
function U(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.Aa[b];if(null==c){c=Aa[b];if(null==c)return null;c=(new C).$(z.f(),c);a.Aa[b]=c}return c}function V(a,b){return L(v(b,3),a)&&L(v(b,2),a)}function fb(a,b){var c=db(a,b);return gb(a,b,c)}function gb(a,b,c){var d=b.e(),f=R(a,d,c);if(null==f||"001"!=c&&d!=Za(a,c))return!1;a=P(b);return eb(a,f)!=J.UNKNOWN}
...
function hb(a,b){var c=U(a,b);if(null==c)return null;c=v(c,12);return 0==c.length?null:c=c.replace("~","")}function ib(a,b){return L(a,b)?K.IS_POSSIBLE:0==b.search(a)?K.TOO_LONG:K.TOO_SHORT}function jb(a,b){var c;c=q(a,1);c=v(c,3);return ib(c,b)==K.TOO_SHORT}function kb(a){var b=W,c=P(a);a=a.e();if(!(a in D))return K.INVALID_COUNTRY_CODE;b=R(b,a,T(a));b=q(b,1);b=v(b,3);return ib(b,c)}
function lb(a,b){var c=a.toString();if(0==c.length||"0"==c.charAt(0))return 0;for(var d,f=c.length,e=1;3>=e&&e<=f;++e)if(d=parseInt(c.substring(0,e),10),d in D)return b.append(c.substring(e)),d;return 0}
...
e=new A;d&&r(e,5,b);a:{b=f.toString();g=b.search(Ka);if(0<=g&&Sa(b.substring(0,g)))for(var h=b.match(Ka),m=h.length,N=1;N<m;++N)if(null!=h[N]&&0<h[N].length){f.clear();f.append(b.substring(0,g));b=h[N];break a}b=""}0<b.length&&r(e,3,b);b=U(a,c);g=new B;h=0;m=f.toString();try{h=mb(m,b,g,d,e)}catch(S){if(S==F.INVALID_COUNTRY_CODE&&H.test(m)){if(m=m.replace(H,""),h=mb(m,b,g,d,e),0==h)throw S;}else throw S;}0!=h?(f=T(h),f!=c&&(b=R(a,h,f))):(Ua(f),g.append(f.toString()),null!=c?(h=b.e(),e.ba(h)):d&&t(e,
6));if(2>g.d.length)throw F.TOO_SHORT_NSN;null!=b&&(a=new B,c=new B(g.toString()),nb(c,b,a),jb(b,c.toString())||(g=c,d&&r(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw F.TOO_SHORT_NSN;if(17<a)throw F.TOO_LONG;if(1<d.length&&"0"==d.charAt(0)){r(e,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&r(e,8,a)}r(e,2,parseInt(d,10));return e}function pb(a,b){var c=U(a,db(a,b));if(null==c)return!0;var d=P(b);return!V(d,q(c,24))}
function L(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};
function Y(a){this.va="\u2008";this.fa=new RegExp(this.va);this.s="";this.r=new B;this.v="";this.j=new B;this.o=new B;this.m=!0;this.aa=this.t=this.na=!1;this.sa=E.xa();this.ta=this.ra=this.u=0;this.c=new B;this.ea=!1;this.p="";this.b=new B;this.h=[];this.ga=a;this.Ba=this.i=qb(this,this.ga)}var rb=new z;r(rb,11,"NA");
var sb=/\[([^\[\]])*\]/g,tb=/\d(?=[^,}][^,}])/g,ub=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,vb=/[- ]/;function qb(a,b){var c=O(b)?Za(a.sa,b):0,c=U(a.sa,T(c));return null!=c?c:rb}
function wb(a){for(var b=a.h.length,c=0;c<b;++c){var d=a.h[c],f=v(d,1);if(a.v==f)return!1;var e;e=a;var g=d,h=v(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(sb,"\\d");h=h.replace(tb,"\\d");e.r.clear();var m;m=e;var g=v(g,2),N="999999999999999".match(h)[0];N.length<m.b.d.length?m="":(h=N.replace(new RegExp(h,"g"),g),m=h=h.replace(/9/g,m.va));0<m.length?(e.r.append(m),e=!0):e=!1}if(e)return a.v=f,a.ea=vb.test(q(d,4)),a.u=0,!0}return a.m=!1}
...
function Fb(a){for(var b=a.b.toString(),c=a.h.length,d=0;d<c;++d){var f=a.h[d],e=v(f,1);if((new RegExp("^(?:"+e+")$")).test(b))return a.ea=vb.test(q(f,4)),b=b.replace(new RegExp(e,"g"),q(f,2)),Hb(a,b)}return""}function Hb(a,b){var c=a.c.d.length;return a.ea&&0<c&&" "!=a.c.toString().charAt(c-1)?a.c+" "+b:a.c+b}Y.prototype.ka=function(){if(!this.m)return this.ra;for(var a=0,b=0,c=this.o.toString(),d=this.s.toString();a<this.ta&&b<d.length;)c.charAt(a)==d.charAt(b)&&a++,b++;return b};
function Db(a){var b=a.b.toString();if(3<=b.length){for(var c=a.t&&0<w(a.i,20)?u(a.i,20)||[]:u(a.i,19)||[],d=c.length,f=0;f<d;++f){var e=c[f],g;(g=!p(a.i,12)||a.t||q(e,6))||(g=v(e,4),g=0==g.length||Qa.test(g));g&&(g=v(e,2),ub.test(g)&&a.h.push(e))}xb(a,b);b=Fb(a);return 0<b.length?b:wb(a)?Gb(a):a.j.toString()}return Hb(a,b)}function Gb(a){var b=a.b.toString(),c=b.length;if(0<c){for(var d="",f=0;f<c;f++)d=Eb(a,b.charAt(f));return a.m?Hb(a,d):a.j.toString()}return a.c.toString()}
function Cb(a){var b=a.b.toString(),c=0,d;1!=a.i.wa()?d=!1:(d=a.b.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.c.append("1").append(" "),a.t=!0):p(a.i,15)&&(d=new RegExp("^(?:"+q(a.i,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.t=!0,c=d[0].length,a.c.append(b.substring(0,c))));a.b.clear();a.b.append(b.substring(c));return b.substring(0,c)}
function zb(a){var b=a.o.toString(),c=new RegExp("^(?:\\+|"+q(a.i,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.t=!0,c=c[0].length,a.b.clear(),a.b.append(b.substring(c)),a.c.clear(),a.c.append(b.substring(0,c)),"+"!=b.charAt(0)&&a.c.append(" "),!0):!1}function Ab(a){if(0==a.b.d.length)return!1;var b=new B,c=lb(a.b,b);if(0==c)return!1;a.b.clear();a.b.append(b.toString());b=T(c);"001"==b?a.i=U(a.sa,""+c):b!=a.ga&&(a.i=qb(a,b));a.c.append(""+c).append(" ");a.p="";return!0}
...
k("leodido.i18n.PhoneNumbers.formatMobileDialing",function(a,b,c){if(!c)return null;a:{var d=X(a,b);a=W;b=d.e();if(b in D){var f="",d=d.clone();t(d,3);var e=T(b),g=cb(a,d),h=g!=J.UNKNOWN;if(c==e)f=g==J.FIXED_LINE||g==J.MOBILE||g==J.FIXED_LINE_OR_MOBILE,"CO"==e&&g==J.FIXED_LINE?f=Xa(a,d,"3"):"BR"==e&&f?f=p(d,7)?Xa(a,d,p(d,7)?v(d,7):""):"":h&&"HU"==e?f=hb(a,e)+" "+a.format(d,I.NATIONAL):1==b?(c=U(a,c),f=pb(a,d)&&!jb(c,P(d))?a.format(d,I.INTERNATIONAL):a.format(d,I.NATIONAL)):f=("001"==e||("MX"==e||
"CL"==e)&&f)&&pb(a,d)?a.format(d,I.INTERNATIONAL):a.format(d,I.NATIONAL);else if(h&&pb(a,d)){c=a.format(d,I.INTERNATIONAL);break a}c=f}else c=p(d,5)?v(d,5):""}return c});k("leodido.i18n.PhoneNumbers.getExampleNumber",function(a,b,c){var d;a:{var f=W;if(O(a)){b=bb(U(f,a),b);try{if(p(b,6)){d=f.parse(v(b,6),a);break a}}catch(e){}}d=null}if(!d)return null;c="undefined"==typeof c?I.E164:c;return W.format(d,c)});k("leodido.i18n.PhoneNumbers.isValidNumber",function(a,b){var c=X(a,b||"us");return fb(W,c)});

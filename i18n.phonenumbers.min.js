...
function y(){p.call(this)}var ua;l(y,p);y.prototype.wa=function(){return r(this,1)};y.prototype.e=function(){return w(this,1)};y.prototype.ba=function(a){t(this,1,a)};y.prototype.getExtension=function(){return r(this,3)};var va={Ha:1,Ga:5,Fa:10,Ea:20};
y.prototype.f=function(){ua||(ua=ta(y,{0:{name:"PhoneNumber",ja:"i18n.phonenumbers.PhoneNumber"},1:{name:"country_code",required:!0,a:5,type:Number},2:{name:"national_number",required:!0,a:4,type:Number},3:{name:"extension",a:9,type:String},4:{name:"italian_leading_zero",a:8,type:Boolean},8:{name:"number_of_leading_zeros",a:5,defaultValue:1,type:Number},5:{name:"raw_input",a:9,type:String},6:{name:"country_code_source",a:14,defaultValue:1,type:va},7:{name:"preferred_domestic_carrier_code",a:9,type:String}}));
return ua};y.ctor=y;y.ctor.f=y.prototype.f;function wa(){}wa.prototype.$=function(a){new a.za;throw Error("Unimplemented");};wa.prototype.ca=function(a,b){if(11==a.q||10==a.q)return b instanceof p?b:this.$(a.qa.prototype.f(),b);if(14==a.q||!a.ha)return b;var c=a.qa;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&"string"==typeof b&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function xa(){}l(xa,wa);xa.prototype.$=function(a,b){var c=new a.za;c.oa=this;c.l=b;c.g={};return c};function z(){}l(z,xa);z.prototype.Da=!1;z.prototype.ca=function(a,b){return 8==a.q?!!b:wa.prototype.ca.apply(this,arguments)};z.prototype.$=function(a,b){var c=b;if(this.Da){var c=[],d;for(d in b)c[parseInt(d,10)+1]=b[d]}return z.Ca.$.call(this,a,c)};function A(a,b){null!=a&&this.append.apply(this,arguments)}A.prototype.d="";A.prototype.set=function(a){this.d=""+a};A.prototype.append=function(a,b,c){this.d+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.d+=arguments[d];return this};A.prototype.clear=function(){this.d=""};A.prototype.toString=function(){return this.d};
function B(){p.call(this)}var ya;l(B,p);function C(){p.call(this)}var za;l(C,p);function D(){p.call(this)}var Aa;l(D,p);D.prototype.wa=function(){return r(this,10)};D.prototype.e=function(){return w(this,10)};D.prototype.ba=function(a){t(this,10,a)};
B.prototype.f=function(){ya||(ya=ta(B,{0:{name:"NumberFormat",ja:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,a:9,type:String},2:{name:"format",required:!0,a:9,type:String},3:{name:"leading_digits_pattern",ua:!0,a:9,type:String},4:{name:"national_prefix_formatting_rule",a:9,type:String},6:{name:"national_prefix_optional_when_formatting",a:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",a:9,type:String}}));return ya};B.ctor=B;B.ctor.f=B.prototype.f;
C.prototype.f=function(){za||(za=ta(C,{0:{name:"PhoneNumberDesc",ja:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",a:9,type:String},3:{name:"possible_number_pattern",a:9,type:String},6:{name:"example_number",a:9,type:String},7:{name:"national_number_matcher_data",a:12,type:String},8:{name:"possible_number_matcher_data",a:12,type:String}}));return za};C.ctor=C;C.ctor.f=C.prototype.f;
D.prototype.f=function(){Aa||(Aa=ta(D,{0:{name:"PhoneMetadata",ja:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",a:11,type:C},2:{name:"fixed_line",a:11,type:C},3:{name:"mobile",a:11,type:C},4:{name:"toll_free",a:11,type:C},5:{name:"premium_rate",a:11,type:C},6:{name:"shared_cost",a:11,type:C},7:{name:"personal_number",a:11,type:C},8:{name:"voip",a:11,type:C},21:{name:"pager",a:11,type:C},25:{name:"uan",a:11,type:C},27:{name:"emergency",a:11,type:C},28:{name:"voicemail",a:11,type:C},24:{name:"no_international_dialling",
...
ua:!0,a:11,type:B},20:{name:"intl_number_format",ua:!0,a:11,type:B},22:{name:"main_country_for_code",a:8,defaultValue:!1,type:Boolean},23:{name:"leading_digits",a:9,type:String},26:{name:"leading_zero_possible",a:8,defaultValue:!1,type:Boolean}}));return Aa};D.ctor=D;D.ctor.f=D.prototype.f;
...
function Sa(a){return 2>a.length?!1:L(La,a)}function Ta(a){return L(Ja,a)?M(a,Ca):M(a,G)}function Ua(a){var b=Ta(a.toString());a.clear();a.append(b)}function M(a,b){for(var c=new A,d,f=a.length,e=0;e<f;++e)d=a.charAt(e),d=b[d.toUpperCase()],null!=d&&c.append(d);return c.toString()}function O(a){return null!=a&&isNaN(a)&&a.toUpperCase()in ba}
...
function U(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.Aa[b];if(null==c){c=ba[b];if(null==c)return null;c=(new z).$(D.f(),c);a.Aa[b]=c}return c}function V(a,b){return L(w(b,3),a)&&L(w(b,2),a)}function fb(a,b){var c;var d=db(a,b),f=b.e();c=R(a,f,d);null==c||"001"!=d&&f!=Za(a,d)?c=!1:(d=P(b),c=eb(d,c)!=J.UNKNOWN);return c}
...
c=kb(a,c);if(0!=c)return f.ba(c),c;throw F.INVALID_COUNTRY_CODE;}if(null!=b&&(e=b.e(),g=""+e,h=a.toString(),0==h.lastIndexOf(g,0))){var m=new A(h.substring(g.length)),h=r(b,1),g=new RegExp(w(h,2));mb(m,b,null);b=m.toString();h=w(h,3);if(!L(g,a.toString())&&L(g,b)||hb(h,a.toString())==K.TOO_LONG)return c.append(b),d&&t(f,6,10),f.ba(e),e}f.ba(0);return 0}
...
function nb(a,b,c,d){if(null==b)throw F.NOT_A_NUMBER;if(250<b.length)throw F.TOO_LONG;var f=new A,e=b.indexOf(";phone-context=");if(0<e){var g=e+15;if("+"==b.charAt(g)){var h=b.indexOf(";",g);0<h?f.append(b.substring(g,h)):f.append(b.substring(g))}g=b.indexOf("tel:");f.append(b.substring(0<=g?g+4:0,e))}else f.append(Ra(b));e=f.toString();g=e.indexOf(";isub=");0<g&&(f.clear(),f.append(e.substring(0,g)));if(!Sa(f.toString()))throw F.NOT_A_NUMBER;e=f.toString();if(!(O(c)||null!=e&&0<e.length&&H.test(e)))throw F.INVALID_COUNTRY_CODE;
e=new y;d&&t(e,5,b);a:{b=f.toString();g=b.search(Ka);if(0<=g&&Sa(b.substring(0,g)))for(var h=b.match(Ka),m=h.length,N=1;N<m;++N)if(null!=h[N]&&0<h[N].length){f.clear();f.append(b.substring(0,g));b=h[N];break a}b=""}0<b.length&&t(e,3,b);b=U(a,c);g=new A;h=0;m=f.toString();try{h=lb(m,b,g,d,e)}catch(S){if(S==F.INVALID_COUNTRY_CODE&&H.test(m)){if(m=m.replace(H,""),h=lb(m,b,g,d,e),0==h)throw S;}else throw S;}0!=h?(f=T(h),f!=c&&(b=R(a,h,f))):(Ua(f),g.append(f.toString()),null!=c?(h=b.e(),e.ba(h)):d&&u(e,
6));if(2>g.d.length)throw F.TOO_SHORT_NSN;null!=b&&(a=new A,c=new A(g.toString()),mb(c,b,a),ib(b,c.toString())||(g=c,d&&t(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw F.TOO_SHORT_NSN;if(17<a)throw F.TOO_LONG;if(1<d.length&&"0"==d.charAt(0)){t(e,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&t(e,8,a)}t(e,2,parseInt(d,10));return e}function ob(a,b){var c=U(a,db(a,b));if(null==c)return!0;var d=P(b);return!V(d,r(c,24))}
function L(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};
function Y(a){this.va="\u2008";this.fa=new RegExp(this.va);this.s="";this.r=new A;this.v="";this.j=new A;this.o=new A;this.m=!0;this.aa=this.t=this.na=!1;this.sa=E.xa();this.ta=this.ra=this.u=0;this.c=new A;this.ea=!1;this.p="";this.b=new A;this.h=[];this.ga=a;this.Ba=this.i=pb(this,this.ga)}var qb=new D;t(qb,11,"NA");
...
function yb(a){var b=a.o.toString(),c=new RegExp("^(?:\\+|"+r(a.i,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.t=!0,c=c[0].length,a.b.clear(),a.b.append(b.substring(c)),a.c.clear(),a.c.append(b.substring(0,c)),"+"!=b.charAt(0)&&a.c.append(" "),!0):!1}function zb(a){if(0==a.b.d.length)return!1;var b=new A,c=kb(a.b,b);if(0==c)return!1;a.b.clear();a.b.append(b.toString());b=T(c);"001"==b?a.i=U(a.sa,""+c):b!=a.ga&&(a.i=pb(a,b));a.c.append(""+c).append(" ");a.p="";return!0}

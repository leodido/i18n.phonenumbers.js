...
function U(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.Aa[b];if(null==c){c=ba[b];if(null==c)return null;c=(new D).$(A.f(),c);a.Aa[b]=c}return c}function V(a,b){return L(x(b,3),a)&&L(x(b,2),a)}function ib(a,b){var c;var d=gb(a,b),f=b.e();c=R(a,f,d);null==c||"001"!=d&&f!=bb(a,d)?c=!1:(d=P(b),c=hb(d,c)!=J.UNKNOWN);return c}
...
function jb(a,b){var c=U(a,b);if(null==c)return null;c=x(c,12);return 0==c.length?null:c=c.replace("~","")}function kb(a,b){return L(a,b)?K.IS_POSSIBLE:0==b.search(a)?K.TOO_LONG:K.TOO_SHORT}function lb(a,b){var c;c=t(a,1);c=x(c,3);return kb(c,b)==K.TOO_SHORT}function mb(a){var b=W,c=P(a);a=a.e();if(!(a in p))return K.INVALID_COUNTRY_CODE;b=R(b,a,T(a));b=t(b,1);b=x(b,3);return kb(b,c)}
...
e=new B;d&&u(e,5,b);a:{b=f.toString();g=b.search(Ma);if(0<=g&&Ua(b.substring(0,g)))for(var h=b.match(Ma),l=h.length,N=1;N<l;++N)if(null!=h[N]&&0<h[N].length){f.clear();f.append(b.substring(0,g));b=h[N];break a}b=""}0<b.length&&u(e,3,b);b=U(a,c);g=new C;h=0;l=f.toString();try{h=ob(l,b,g,d,e)}catch(S){if(S==F.INVALID_COUNTRY_CODE&&H.test(l)){if(l=l.replace(H,""),h=ob(l,b,g,d,e),0==h)throw S;}else throw S;}0!=h?(f=T(h),f!=c&&(b=R(a,h,f))):(Wa(f),g.append(f.toString()),null!=c?(h=b.e(),e.ba(h)):d&&v(e,
6));if(2>g.d.length)throw F.TOO_SHORT_NSN;null!=b&&(a=new C,c=new C(g.toString()),pb(c,b,a),lb(b,c.toString())||(g=c,d&&u(e,7,a.toString())));d=g.toString();a=d.length;if(2>a)throw F.TOO_SHORT_NSN;if(17<a)throw F.TOO_LONG;if(1<d.length&&"0"==d.charAt(0)){u(e,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&u(e,8,a)}u(e,2,parseInt(d,10));return e}function rb(a,b){var c=U(a,gb(a,b));if(null==c)return!0;var d=P(b);return!V(d,t(c,24))}
function L(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};
function Y(a){this.va="\u2008";this.fa=new RegExp(this.va);this.s="";this.r=new C;this.v="";this.j=new C;this.o=new C;this.m=!0;this.aa=this.t=this.na=!1;this.sa=E.xa();this.ta=this.ra=this.u=0;this.c=new C;this.ea=!1;this.p="";this.b=new C;this.h=[];this.ga=a;this.Ba=this.i=sb(this,this.ga)}var tb=new A;u(tb,11,"NA");
var ub=/\[([^\[\]])*\]/g,vb=/\d(?=[^,}][^,}])/g,wb=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,xb=/[- ]/;function sb(a,b){var c=O(b)?bb(a.sa,b):0,c=U(a.sa,T(c));return null!=c?c:tb}
function yb(a){for(var b=a.h.length,c=0;c<b;++c){var d=a.h[c],f=x(d,1);if(a.v==f)return!1;var e;e=a;var g=d,h=x(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(ub,"\\d");h=h.replace(vb,"\\d");e.r.clear();var l;l=e;var g=x(g,2),N="999999999999999".match(h)[0];N.length<l.b.d.length?l="":(h=N.replace(new RegExp(h,"g"),g),l=h=h.replace(/9/g,l.va));0<l.length?(e.r.append(l),e=!0):e=!1}if(e)return a.v=f,a.ea=xb.test(t(d,4)),a.u=0,!0}return a.m=!1}
...
function Hb(a){for(var b=a.b.toString(),c=a.h.length,d=0;d<c;++d){var f=a.h[d],e=x(f,1);if((new RegExp("^(?:"+e+")$")).test(b))return a.ea=xb.test(t(f,4)),b=b.replace(new RegExp(e,"g"),t(f,2)),Jb(a,b)}return""}function Jb(a,b){var c=a.c.d.length;return a.ea&&0<c&&" "!=a.c.toString().charAt(c-1)?a.c+" "+b:a.c+b}Y.prototype.ka=function(){if(!this.m)return this.ra;for(var a=0,b=0,c=this.o.toString(),d=this.s.toString();a<this.ta&&b<d.length;)c.charAt(a)==d.charAt(b)&&a++,b++;return b};
function Fb(a){var b=a.b.toString();if(3<=b.length){for(var c=a.t&&0<ua(a.i,20)?w(a.i,20)||[]:w(a.i,19)||[],d=c.length,f=0;f<d;++f){var e=c[f],g;(g=!r(a.i,12)||a.t||t(e,6))||(g=x(e,4),g=0==g.length||Sa.test(g));g&&(g=x(e,2),wb.test(g)&&a.h.push(e))}zb(a,b);b=Hb(a);return 0<b.length?b:yb(a)?Ib(a):a.j.toString()}return Jb(a,b)}function Ib(a){var b=a.b.toString(),c=b.length;if(0<c){for(var d="",f=0;f<c;f++)d=Gb(a,b.charAt(f));return a.m?Jb(a,d):a.j.toString()}return a.c.toString()}
function Eb(a){var b=a.b.toString(),c=0,d;1!=a.i.wa()?d=!1:(d=a.b.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.c.append("1").append(" "),a.t=!0):r(a.i,15)&&(d=new RegExp("^(?:"+t(a.i,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.t=!0,c=d[0].length,a.c.append(b.substring(0,c))));a.b.clear();a.b.append(b.substring(c));return b.substring(0,c)}
function Bb(a){var b=a.o.toString(),c=new RegExp("^(?:\\+|"+t(a.i,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.t=!0,c=c[0].length,a.b.clear(),a.b.append(b.substring(c)),a.c.clear(),a.c.append(b.substring(0,c)),"+"!=b.charAt(0)&&a.c.append(" "),!0):!1}function Cb(a){if(0==a.b.d.length)return!1;var b=new C,c=nb(a.b,b);if(0==c)return!1;a.b.clear();a.b.append(b.toString());b=T(c);"001"==b?a.i=U(a.sa,""+c):b!=a.ga&&(a.i=sb(a,b));a.c.append(""+c).append(" ");a.p="";return!0}
...
u(g,4,l)):v(g,4)}l=db(e,g,h)}f=Ya(c,f,h);f=Q(d,h,l,f)}else f=e}c=x(c,5);null!=f&&0<c.length&&(h=M(f,Da),d=M(c,Da),h!=d&&(f=c));c=f}else c=f.format(c,I.NATIONAL);else c=x(c,5);return c});m("leodido.i18n.PhoneNumbers.formatOutOfCountryCalling",function(a,b,c){if(!c)return null;a=X(a,b);return ab(W,a,c)});
m("leodido.i18n.PhoneNumbers.formatMobileDialing",function(a,b,c){if(!c)return null;a:{var d=X(a,b);a=W;b=d.e();if(b in p){var f="",d=d.clone();v(d,3);var e=T(b),g=fb(a,d),h=g!=J.UNKNOWN;if(c==e)f=g==J.FIXED_LINE||g==J.MOBILE||g==J.FIXED_LINE_OR_MOBILE,"CO"==e&&g==J.FIXED_LINE?f=$a(a,d,"3"):"BR"==e&&f?f=r(d,7)?$a(a,d,r(d,7)?x(d,7):""):"":h&&"HU"==e?f=jb(a,e)+" "+a.format(d,I.NATIONAL):1==b?(c=U(a,c),f=rb(a,d)&&!lb(c,P(d))?a.format(d,I.INTERNATIONAL):a.format(d,I.NATIONAL)):f=("001"==e||("MX"==e||
"CL"==e)&&f)&&rb(a,d)?a.format(d,I.INTERNATIONAL):a.format(d,I.NATIONAL);else if(h&&rb(a,d)){c=a.format(d,I.INTERNATIONAL);break a}c=f}else c=r(d,5)?x(d,5):""}return c});m("leodido.i18n.PhoneNumbers.getExampleNumber",function(a,b,c){var d;a:{var f=W;if(O(a)){b=eb(U(f,a),b);try{if(r(b,6)){d=f.parse(x(b,6),a);break a}}catch(e){}}d=null}if(!d)return null;c="undefined"==typeof c?I.E164:c;return W.format(d,c)});m("leodido.i18n.PhoneNumbers.isValidNumber",function(a,b){var c=X(a,b||"us");return ib(W,c)});

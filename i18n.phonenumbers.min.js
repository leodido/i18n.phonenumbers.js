...
function y(){q.call(this)}var wa;n(y,q);y.prototype.wa=function(){return t(this,1)};y.prototype.e=function(){return x(this,1)};y.prototype.ba=function(a){u(this,1,a)};y.prototype.getExtension=function(){return t(this,3)};var xa={Ha:1,Ga:5,Fa:10,Ea:20};
y.prototype.f=function(){wa||(wa=va(y,{0:{name:"PhoneNumber",ja:"i18n.phonenumbers.PhoneNumber"},1:{name:"country_code",required:!0,a:5,type:Number},2:{name:"national_number",required:!0,a:4,type:Number},3:{name:"extension",a:9,type:String},4:{name:"italian_leading_zero",a:8,type:Boolean},8:{name:"number_of_leading_zeros",a:5,defaultValue:1,type:Number},5:{name:"raw_input",a:9,type:String},6:{name:"country_code_source",a:14,defaultValue:1,type:xa},7:{name:"preferred_domestic_carrier_code",a:9,type:String}}));
return wa};y.ctor=y;y.ctor.f=y.prototype.f;
function z(){q.call(this)}var ya;n(z,q);function A(){q.call(this)}var za;n(A,q);function B(){q.call(this)}var Aa;n(B,q);B.prototype.wa=function(){return t(this,10)};B.prototype.e=function(){return x(this,10)};B.prototype.ba=function(a){u(this,10,a)};
z.prototype.f=function(){ya||(ya=va(z,{0:{name:"NumberFormat",ja:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,a:9,type:String},2:{name:"format",required:!0,a:9,type:String},3:{name:"leading_digits_pattern",ua:!0,a:9,type:String},4:{name:"national_prefix_formatting_rule",a:9,type:String},6:{name:"national_prefix_optional_when_formatting",a:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",a:9,type:String}}));return ya};z.ctor=z;z.ctor.f=z.prototype.f;
A.prototype.f=function(){za||(za=va(A,{0:{name:"PhoneNumberDesc",ja:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",a:9,type:String},3:{name:"possible_number_pattern",a:9,type:String},6:{name:"example_number",a:9,type:String},7:{name:"national_number_matcher_data",a:12,type:String},8:{name:"possible_number_matcher_data",a:12,type:String}}));return za};A.ctor=A;A.ctor.f=A.prototype.f;
B.prototype.f=function(){Aa||(Aa=va(B,{0:{name:"PhoneMetadata",ja:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",a:11,type:A},2:{name:"fixed_line",a:11,type:A},3:{name:"mobile",a:11,type:A},4:{name:"toll_free",a:11,type:A},5:{name:"premium_rate",a:11,type:A},6:{name:"shared_cost",a:11,type:A},7:{name:"personal_number",a:11,type:A},8:{name:"voip",a:11,type:A},21:{name:"pager",a:11,type:A},25:{name:"uan",a:11,type:A},27:{name:"emergency",a:11,type:A},28:{name:"voicemail",a:11,type:A},24:{name:"no_international_dialling",
...
e=new y;d&&u(e,5,b);a:{b=f.toString();g=b.search(Ma);if(0<=g&&Ua(b.substring(0,g)))for(var h=b.match(Ma),l=h.length,N=1;N<l;++N)if(null!=h[N]&&0<h[N].length){f.clear();f.append(b.substring(0,g));b=h[N];break a}b=""}0<b.length&&u(e,3,b);b=U(a,c);g=new D;h=0;l=f.toString();try{h=pb(l,b,g,d,e)}catch(S){if(S==F.INVALID_COUNTRY_CODE&&H.test(l)){if(l=l.replace(H,""),h=pb(l,b,g,d,e),0==h)throw S;}else throw S;}0!=h?(f=T(h),f!=c&&(b=R(a,h,f))):(Wa(f),g.append(f.toString()),null!=c?(h=b.e(),e.ba(h)):d&&v(e,
...
var tb={INVALID_COUNTRY_CODE:F.INVALID_COUNTRY_CODE,NOT_A_NUMBER:F.NOT_A_NUMBER,TOO_SHORT_AFTER_IDD:F.TOO_SHORT_AFTER_IDD,TOO_SHORT_NSN:F.TOO_SHORT_NSN,TOO_LONG:F.TOO_LONG};
function Y(a){this.va="\u2008";this.fa=new RegExp(this.va);this.s="";this.r=new D;this.v="";this.j=new D;this.o=new D;this.m=!0;this.aa=this.t=this.na=!1;this.sa=E.xa();this.ta=this.ra=this.u=0;this.c=new D;this.ea=!1;this.p="";this.b=new D;this.h=[];this.ga=a;this.Ba=this.i=ub(this,this.ga)}var vb=new B;u(vb,11,"NA");
var wb=/\[([^\[\]])*\]/g,xb=/\d(?=[^,}][^,}])/g,yb=/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*(\$\d[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]*)+$/,zb=/[- ]/;function ub(a,b){var c=O(b)?bb(a.sa,b):0,c=U(a.sa,T(c));return null!=c?c:vb}
function Ab(a){for(var b=a.h.length,c=0;c<b;++c){var d=a.h[c],f=x(d,1);if(a.v==f)return!1;var e;e=a;var g=d,h=x(g,1);if(-1!=h.indexOf("|"))e=!1;else{h=h.replace(wb,"\\d");h=h.replace(xb,"\\d");e.r.clear();var l;l=e;var g=x(g,2),N="999999999999999".match(h)[0];N.length<l.b.d.length?l="":(h=N.replace(new RegExp(h,"g"),g),l=h=h.replace(/9/g,l.va));0<l.length?(e.r.append(l),e=!0):e=!1}if(e)return a.v=f,a.ea=zb.test(t(d,4)),a.u=0,!0}return a.m=!1}
function Bb(a,b){for(var c=[],d=b.length-3,f=a.h.length,e=0;e<f;++e){var g=a.h[e];if(0==ua(g,3))c.push(a.h[e]);else{var h=Math.min(d,ua(g,3)-1),g=t(g,3,h);0==b.search(g)&&c.push(a.h[e])}}a.h=c}Y.prototype.clear=function(){this.s="";this.j.clear();this.o.clear();this.r.clear();this.u=0;this.v="";this.c.clear();this.p="";this.b.clear();this.m=!0;this.na=!1;this.ra=this.ta=0;this.aa=this.t=!1;this.h=[];this.ea=!1;this.i!=this.Ba&&(this.i=ub(this,this.ga))};
Y.prototype.la=function(a){return this.s=Cb(this,a,!1)};Y.prototype.ma=function(a){return this.s=Cb(this,a,!0)};
function Cb(a,b,c){a.j.append(b);c&&(a.ra=a.j.d.length);var d=b;Ha.test(d)||1==a.j.d.length&&Ga.test(d)?("+"==b?(d=b,a.o.append(b)):(d=G[b],a.o.append(d),a.b.append(d)),c&&(a.ta=a.o.d.length),b=d):(a.m=!1,a.na=!0);if(!a.m){if(!a.na)if(Db(a)){if(Eb(a))return Fb(a)}else if(0<a.p.length&&(c=a.b.toString(),a.b.clear(),a.b.append(a.p),a.b.append(c),c=a.c.toString(),b=c.lastIndexOf(a.p),a.c.clear(),a.c.append(c.substring(0,b))),a.p!=Gb(a))return a.c.append(" "),Fb(a);return a.j.toString()}switch(a.o.d.length){case 0:case 1:case 2:return a.j.toString();
case 3:if(Db(a))a.aa=!0;else return a.p=Gb(a),Hb(a);default:if(a.aa)return Eb(a)&&(a.aa=!1),a.c.toString()+a.b.toString();if(0<a.h.length){c=Ib(a,b);b=Jb(a);if(0<b.length)return b;Bb(a,a.b.toString());return Ab(a)?Kb(a):a.m?Lb(a,c):a.j.toString()}return Hb(a)}}function Fb(a){a.m=!0;a.aa=!1;a.h=[];a.u=0;a.r.clear();a.v="";return Hb(a)}
function Jb(a){for(var b=a.b.toString(),c=a.h.length,d=0;d<c;++d){var f=a.h[d],e=x(f,1);if((new RegExp("^(?:"+e+")$")).test(b))return a.ea=zb.test(t(f,4)),b=b.replace(new RegExp(e,"g"),t(f,2)),Lb(a,b)}return""}function Lb(a,b){var c=a.c.d.length;return a.ea&&0<c&&" "!=a.c.toString().charAt(c-1)?a.c+" "+b:a.c+b}Y.prototype.ka=function(){if(!this.m)return this.ra;for(var a=0,b=0,c=this.o.toString(),d=this.s.toString();a<this.ta&&b<d.length;)c.charAt(a)==d.charAt(b)&&a++,b++;return b};
function Hb(a){var b=a.b.toString();if(3<=b.length){for(var c=a.t&&0<ua(a.i,20)?w(a.i,20)||[]:w(a.i,19)||[],d=c.length,f=0;f<d;++f){var e=c[f],g;(g=!r(a.i,12)||a.t||t(e,6))||(g=x(e,4),g=0==g.length||Sa.test(g));g&&(g=x(e,2),yb.test(g)&&a.h.push(e))}Bb(a,b);b=Jb(a);return 0<b.length?b:Ab(a)?Kb(a):a.j.toString()}return Lb(a,b)}function Kb(a){var b=a.b.toString(),c=b.length;if(0<c){for(var d="",f=0;f<c;f++)d=Ib(a,b.charAt(f));return a.m?Lb(a,d):a.j.toString()}return a.c.toString()}
function Gb(a){var b=a.b.toString(),c=0,d;1!=a.i.wa()?d=!1:(d=a.b.toString(),d="1"==d.charAt(0)&&"0"!=d.charAt(1)&&"1"!=d.charAt(1));d?(c=1,a.c.append("1").append(" "),a.t=!0):r(a.i,15)&&(d=new RegExp("^(?:"+t(a.i,15)+")"),d=b.match(d),null!=d&&null!=d[0]&&0<d[0].length&&(a.t=!0,c=d[0].length,a.c.append(b.substring(0,c))));a.b.clear();a.b.append(b.substring(c));return b.substring(0,c)}
function Db(a){var b=a.o.toString(),c=new RegExp("^(?:\\+|"+t(a.i,11)+")"),c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.t=!0,c=c[0].length,a.b.clear(),a.b.append(b.substring(c)),a.c.clear(),a.c.append(b.substring(0,c)),"+"!=b.charAt(0)&&a.c.append(" "),!0):!1}function Eb(a){if(0==a.b.d.length)return!1;var b=new D,c=ob(a.b,b);if(0==c)return!1;a.b.clear();a.b.append(b.toString());b=T(c);"001"==b?a.i=U(a.sa,""+c):b!=a.ga&&(a.i=ub(a,b));a.c.append(""+c).append(" ");a.p="";return!0}
function Ib(a,b){var c=a.r.toString();if(0<=c.substring(a.u).search(a.fa)){var d=c.search(a.fa),c=c.replace(a.fa,b);a.r.clear();a.r.append(c);a.u=d;return c.substring(0,a.u+1)}1==a.h.length&&(a.m=!1);a.v="";return a.j.toString()};var Mb={IS_POSSIBLE:K.IS_POSSIBLE,INVALID_COUNTRY_CODE:K.INVALID_COUNTRY_CODE,TOO_SHORT:K.TOO_SHORT,TOO_LONG:K.TOO_LONG};var Nb={E164:I.E164,INTERNATIONAL:I.INTERNATIONAL,NATIONAL:I.NATIONAL,RFC3966:I.RFC3966};var Ob={FIXED_LINE:J.FIXED_LINE,MOBILE:J.MOBILE,FIXED_LINE_OR_MOBILE:J.FIXED_LINE_OR_MOBILE,TOLL_FREE:J.TOLL_FREE,PREMIUM_RATE:J.PREMIUM_RATE,SHARED_COST:J.SHARED_COST,VOIP:J.VOIP,PERSONAL_NUMBER:J.PERSONAL_NUMBER,PAGER:J.PAGER,UAN:J.UAN,VOICEMAIL:J.VOICEMAIL,UNKNOWN:J.UNKNOWN};var W=E.xa();m("leodido.i18n.PhoneNumbers",function(){});m("leodido.i18n.PhoneNumbers.getNumberType",function(a,b){var c=X(a,b||"us");return fb(W,c)});m("leodido.i18n.PhoneNumbers.getRegionCodeForNumber",function(a,b){var c=X(a,b||"us");return gb(W,c)});m("leodido.i18n.PhoneNumbers.formatNumber",function(a,b,c){a=X(a,b||"us");c="undefined"==typeof c?I.E164:c;return W.format(a,c)});

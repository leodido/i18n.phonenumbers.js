...
,"NA","NA"],,,[,,"NA","NA"],[,,"\\d{11}","\\d{11}",,,"12345678901"],1,,[,,"NA","NA"]],979:[,[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA",,,"123456789"],[,,"NA","NA"],[,,"\\d{9}","\\d{9}",,,"123456789"],[,,"NA","NA"],[,,"NA","NA"],[,,"NA","NA"],"001",979,"",,,,,,,1,[[,"(\\d)(\\d{4})(\\d{4})","$1 $2 $3",,"","",0]],,[,,"NA","NA"],,,[,,"NA","NA"],[,,"NA","NA"],1,,[,,"NA","NA"]]};var ca=Array.prototype,da=ca.indexOf?function(a,b,c){return ca.indexOf.call(a,b,c)}:function(a,b,c){c=null==c?0:0>c?Math.max(0,a.length+c):c;if("string"==typeof a)return"string"==typeof b&&1==b.length?a.indexOf(b,c):-1;for(;c<a.length;c++)if(c in a&&a[c]===b)return c;return-1};function fa(a,b){a.sort(b||ga)}function ga(a,b){return a>b?1:a<b?-1:0};function ha(a){var b=[],c=0,d;for(d in a)b[c++]=a[d];return b};function ia(a,b,c){this.v=a;this.r=b.name||null;this.h={};for(a=0;a<c.length;a++)b=c[a],this.h[b.e]=b}ia.prototype.getName=function(){return this.r};function ja(a){a=ha(a.h);fa(a,function(a,c){return a.e-c.e});return a};function ka(a,b,c){this.e=b;this.r=c.name;this.n=!!c.t;this.i=c.a;this.s=c.type;this.o=!1;switch(this.i){case la:case ma:case na:case oa:case pa:case qa:case ra:this.o=!0}this.j=c.defaultValue}var ra=1,qa=2,la=3,ma=4,na=6,oa=16,pa=18;ka.prototype.getName=function(){return this.r};function p(){this.f={};this.h=this.b().h;this.c=this.q=null}p.prototype.has=function(a){return q(this,a.e)};p.prototype.get=function(a,b){return r(this,a.e,b)};p.prototype.set=function(a,b){t(this,a.e,b)};p.prototype.add=function(a,b){sa(this,a.e,b)};p.prototype.clear=function(a){u(this,a.e)};
function ta(a,b){for(var c=ja(a.b()),d=0;d<c.length;d++){var e=c[d],f=e.e;if(q(b,f)){a.c&&delete a.c[e.e];var g=11==e.i||10==e.i;if(e.n)for(var e=v(b,f)||[],h=0;h<e.length;h++)sa(a,f,g?e[h].clone():e[h]);else e=v(b,f),g?(g=v(a,f))?ta(g,e):t(a,f,e.clone()):t(a,f,e)}}}p.prototype.clone=function(){var a=new this.constructor;a!=this&&(a.f={},a.c&&(a.c={}),ta(a,this));return a};function q(a,b){return null!=a.f[b]}
...
function t(a,b,c){a.f[b]=c;a.c&&(a.c[b]=c)}function sa(a,b,c){a.f[b]||(a.f[b]=[]);a.f[b].push(c);a.c&&delete a.c[b]}function u(a,b){delete a.f[b];a.c&&delete a.c[b]}function x(a,b){var c=[],d=b[0],e;for(e in b)0!=e&&c.push(new ka(0,e,b[e]));return new ia(a,d,c)};
function y(){p.call(this)}var z;m(y,p);function A(){p.call(this)}var B;m(A,p);function C(){p.call(this)}var D;m(C,p);C.prototype.d=function(){return w(this,10)};C.prototype.l=function(a){t(this,10,a)};
y.prototype.b=function(){z||(z=x(y,{0:{name:"NumberFormat",p:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:!0,a:9,type:String},2:{name:"format",required:!0,a:9,type:String},3:{name:"leading_digits_pattern",t:!0,a:9,type:String},4:{name:"national_prefix_formatting_rule",a:9,type:String},6:{name:"national_prefix_optional_when_formatting",a:8,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",a:9,type:String}}));return z};y.ctor=y;y.ctor.b=y.prototype.b;
A.prototype.b=function(){B||(B=x(A,{0:{name:"PhoneNumberDesc",p:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",a:9,type:String},3:{name:"possible_number_pattern",a:9,type:String},6:{name:"example_number",a:9,type:String},7:{name:"national_number_matcher_data",a:12,type:String},8:{name:"possible_number_matcher_data",a:12,type:String}}));return B};A.ctor=A;A.ctor.b=A.prototype.b;
C.prototype.b=function(){D||(D=x(C,{0:{name:"PhoneMetadata",p:"i18n.phonenumbers.PhoneMetadata"},1:{name:"general_desc",a:11,type:A},2:{name:"fixed_line",a:11,type:A},3:{name:"mobile",a:11,type:A},4:{name:"toll_free",a:11,type:A},5:{name:"premium_rate",a:11,type:A},6:{name:"shared_cost",a:11,type:A},7:{name:"personal_number",a:11,type:A},8:{name:"voip",a:11,type:A},21:{name:"pager",a:11,type:A},25:{name:"uan",a:11,type:A},27:{name:"emergency",a:11,type:A},28:{name:"voicemail",a:11,type:A},24:{name:"no_international_dialling",
...
t:!0,a:11,type:y},20:{name:"intl_number_format",t:!0,a:11,type:y},22:{name:"main_country_for_code",a:8,defaultValue:!1,type:Boolean},23:{name:"leading_digits",a:9,type:String},26:{name:"leading_zero_possible",a:8,defaultValue:!1,type:Boolean}}));return D};C.ctor=C;C.ctor.b=C.prototype.b;function E(a,b){null!=a&&this.append.apply(this,arguments)}E.prototype.g="";E.prototype.set=function(a){this.g=""+a};E.prototype.append=function(a,b,c){this.g+=a;if(null!=b)for(var d=1;d<arguments.length;d++)this.g+=arguments[d];return this};E.prototype.clear=function(){this.g=""};E.prototype.toString=function(){return this.g};
function F(){p.call(this)}var G;m(F,p);F.prototype.d=function(){return w(this,1)};F.prototype.l=function(a){t(this,1,a)};F.prototype.getExtension=function(){return r(this,3)};var ua={fa:1,ea:5,da:10,ca:20};
F.prototype.b=function(){G||(G=x(F,{0:{name:"PhoneNumber",p:"i18n.phonenumbers.PhoneNumber"},1:{name:"country_code",required:!0,a:5,type:Number},2:{name:"national_number",required:!0,a:4,type:Number},3:{name:"extension",a:9,type:String},4:{name:"italian_leading_zero",a:8,type:Boolean},8:{name:"number_of_leading_zeros",a:5,defaultValue:1,type:Number},5:{name:"raw_input",a:9,type:String},6:{name:"country_code_source",a:14,defaultValue:1,type:ua},7:{name:"preferred_domestic_carrier_code",a:9,type:String}}));
return G};F.ctor=F;F.ctor.b=F.prototype.b;function H(){}H.prototype.k=function(a){new a.v;throw Error("Unimplemented");};H.prototype.m=function(a,b){if(11==a.i||10==a.i)return b instanceof p?b:this.k(a.s.prototype.b(),b);if(14==a.i||!a.o)return b;var c=a.s;if(c===String){if("number"==typeof b)return String(b)}else if(c===Number&&"string"==typeof b&&("Infinity"===b||"-Infinity"===b||"NaN"===b||/^-?[0-9]+$/.test(b)))return Number(b);return b};function I(){}m(I,H);I.prototype.k=function(a,b){var c=new a.v;c.q=this;c.f=b;c.c={};return c};function J(){}m(J,I);J.prototype.ba=!1;J.prototype.m=function(a,b){return 8==a.i?!!b:H.prototype.m.apply(this,arguments)};J.prototype.k=function(a,b){var c=b;if(this.ba){var c=[],d;for(d in b)c[parseInt(d,10)+1]=b[d]}return J.aa.k.call(this,a,c)};
...
Fa=/(\$\d)/,Ga=/\$NP/,Ha=/\$FG/,Ia=/\$CC/;function Ja(a){var b=a.search(za);0<=b?(a=a.substring(b),a=a.replace(Ba,""),b=a.search(Aa),0<=b&&(a=a.substring(0,b))):a="";return a}function Ka(a){return 2>a.length?!1:O(Ea,a)}function La(a){return O(Ca,a)?P(a,wa):P(a,L)}function Ma(a){var b=La(a.toString());a.clear();a.append(b)}function P(a,b){for(var c=new E,d,e=a.length,f=0;f<e;++f)d=a.charAt(f),d=b[d.toUpperCase()],null!=d&&c.append(d);return c.toString()}
...
a:{d=a.toString();if(0!=d.length&&"0"!=d.charAt(0))for(b=d.length,f=1;3>=f&&f<=b;++f)if(a=parseInt(d.substring(0,f),10),a in n){c.append(d.substring(f));c=a;break a}c=0}if(0!=c)return e.l(c),c;throw"Invalid country calling code";}if(null!=b&&(f=b.d(),g=""+f,h=a.toString(),0==h.lastIndexOf(g,0))){var k=new E(h.substring(g.length)),h=r(b,1),g=new RegExp(w(h,2));Za(k,b,null);b=k.toString();h=w(h,3);if(!O(g,a.toString())&&O(g,b)||3==Wa(h,a.toString()))return c.append(b),d&&t(e,6,10),e.l(f),f}e.l(0);return 0}
...
function $a(a,b,c,d){if(null==b)throw"The string supplied did not seem to be a phone number";if(250<b.length)throw"The string supplied is too long to be a phone number";var e=new E,f=b.indexOf(";phone-context=");if(0<f){var g=f+15;if("+"==b.charAt(g)){var h=b.indexOf(";",g);0<h?e.append(b.substring(g,h)):e.append(b.substring(g))}g=b.indexOf("tel:");e.append(b.substring(0<=g?g+4:0,f))}else e.append(Ja(b));f=e.toString();g=f.indexOf(";isub=");0<g&&(e.clear(),e.append(f.substring(0,g)));if(!Ka(e.toString()))throw"The string supplied did not seem to be a phone number";
f=e.toString();if(!(Q(c)||null!=f&&0<f.length&&N.test(f)))throw"Invalid country calling code";f=new F;d&&t(f,5,b);a:{b=e.toString();g=b.search(Da);if(0<=g&&Ka(b.substring(0,g)))for(var h=b.match(Da),k=h.length,M=1;M<k;++M)if(null!=h[M]&&0<h[M].length){e.clear();e.append(b.substring(0,g));b=h[M];break a}b=""}0<b.length&&t(f,3,b);g=V(a,c);b=new E;h=0;k=e.toString();try{h=Ya(k,g,b,d,f)}catch(ea){if("Invalid country calling code"==ea&&N.test(k)){if(k=k.replace(N,""),h=Ya(k,g,b,d,f),0==h)throw ea;}else throw ea;
}0!=h?(e=U(h),e!=c&&(g=T(a,h,e))):(Ma(e),b.append(e.toString()),null!=c?(h=g.d(),f.l(h)):d&&u(f,6));if(2>b.g.length)throw"The string supplied is too short to be a phone number";null!=g&&(a=new E,c=new E(b.toString()),Za(c,g,a),e=c.toString(),g=r(g,1),g=w(g,3),2!=Wa(g,e)&&(b=c,d&&t(f,7,a.toString())));d=b.toString();a=d.length;if(2>a)throw"The string supplied is too short to be a phone number";if(17<a)throw"The string supplied is too long to be a phone number";if(1<d.length&&"0"==d.charAt(0)){t(f,
